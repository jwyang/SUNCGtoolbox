...
CreateAndWriteCameras(void)
{
  ...
  // Create cameras
  if (create_object_cameras) {
  	print("creat object cameras")
  	CreateObjectCameras();
  }
  if (create_room_cameras) {
  	print("creat room cameras")  	
  	CreateRoomCameras();
  }
  if (create_world_in_hand_cameras) {
  	print("creat world in hand cameras")  	
